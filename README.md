...
curl -s http://127.0.0.1:11434/api/embed \
  -d '{"model":"bge-m3","input":"Mộc Lam Latte giá bao nhiêu"}' \
...
```json
{
    ...
    "top_score": 0.82,
    "threshold": 0.51,
    "chunks": [{"chunk_id": "menu:ML_PEACH_TEA", "score": 0.82, "text": "Món: Trà Đào Cam Sả ..."}]
}
```
...
```json
{
    "response": "{\"intent\":\"MENU_QA\",\"answerText\":\"Trà Đào Cam Sả có giá 45.000 VNĐ bạn nhé!\",\"requiresHumanSupport\":false,\"sourceIds\":[\"menu:ML_PEACH_TEA\"]}",
    "retrieval": {"in_scope": true, "top_score": 0.82, "threshold": 0.51,
                  "sourceIds": ["menu:ML_PEACH_TEA"]}
}
```
