...
(`menu:ML_PEACH_TEA`), nhưng model thêm câu *"Đây là món best seller của Mộc Lam"* —
trong khi KB nói **Mộc Lam Latte** mới là best seller. Model trộn thuộc tính giữa các
