...
```json
{
  "response": "{\"intent\":\"MENU_QA\",\"confidence\":0.95,\"answerText\":\"Latte có caffeine vì được pha từ espresso...\",\"recommendedItems\":[{\"menuItemId\":\"ML_LATTE\",\"reason\":\"...\"}],...}"
}
```
...
```json
{
  ...
  "recommendedItems": [
    { "menuItemId": "ML_LATTE", "reason": "Lý do gợi ý" }
  ],
  "draftCartItems": [],
