...
```json
{
  "response": "{\"intent\":\"MENU_QA\",\"answerText\":\"...\",\"sourceIds\":[\"menu:ML_LATTE\"]}",
  "retrieval": { "in_scope": true, "top_score": 0.71, "threshold": 0.51, "sourceIds": ["menu:ML_LATTE"] }
}
```
...
```json
{
  ...
  "recommendedItems": [{ "menuItemId": "ML_LATTE", "reason": "Lý do gợi ý" }],
  "draftCartItems": [],
  "requiresHumanSupport": false,
  "sourceIds": ["menu:ML_LATTE"]
}
```
