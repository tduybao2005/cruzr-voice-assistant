...
def test_ollama(model="cadebot-moclam"):
    import requests
...
def test_llm(model="cadebot-moclam"):
...
def test_tts():
    ...
    speak("Xin chào! Tôi là Cadebot, trợ lý robot tại Cà Phê Mộc Lam.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="cadebot-moclam")
