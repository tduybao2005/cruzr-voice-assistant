...
FALLBACK_TEXT = (
    ...
    "Bạn vui lòng hỏi nhân viên Mộc Lam để được hỗ trợ nhé!"
)
...
def sanitize_response(raw: str, allowed_ids: list[str]) -> str:
    ...
    Model hay bịa ID không tồn tại, hoặc trả thiếu tiền tố ('ML_TIRAMISU' thay vì
    'menu:ML_TIRAMISU'). Cái sau sửa được nên sửa, cái trước bỏ.
